...
public abstract class AbstractSelectActionAction extends GotoActionBase implements DumbAware {
    ...
    @NotNull
    private ChooseByNamePopup createPopup(@Nullable Project project,
    ...
    private boolean processOptionInplace(Object value, ChooseByNamePopup popup, Component component, AnActionEvent e) {
    ...
    private void repaint(@Nullable ChooseByNamePopup popup) {
        if (popup != null) {
            popup.repaintListImmediate();
        }
    }

    public void openOptionOrPerformAction(@NotNull Object element, String enteredText, @Nullable Project project, Component component) {
        openOptionOrPerformAction(element, enteredText, project, component, 0);
    }

    private void openOptionOrPerformAction(Object element,
                                           String enteredText,
    ...
    public void performAction(@NotNull Object element, @Nullable Component component, @Nullable AnActionEvent e) {
        performAction(element, component, e, 0, null);
    }

    public abstract void actionSelected(@NotNull AnAction action);

    private void performAction(Object element,
